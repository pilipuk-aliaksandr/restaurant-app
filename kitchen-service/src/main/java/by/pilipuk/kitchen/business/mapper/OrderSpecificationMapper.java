...
public class OrderSpecificationMapper {
    ...
    public Specification<Order> kitchenOrderSpecification(OrderRequestDto kitchenRequestDto) {
    ...
    public static Specification<Order> hasOrderIds(List<Long> ordersIds) {
        return (root, query, criteriaBuilder) -> {
